...
Programs are compiled twice, once with additional symbolic tracing for the high-speed concolic engine and once more instrumented for a fuzzer (we use a modified version of [AFL](https://github.com/google/AFL)) to quickly explore easy-to-find execution paths.
